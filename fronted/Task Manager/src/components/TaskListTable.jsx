...
const TaskListTable = ({ tableData }) => {
  ...
  return (
    <div className="overflow-x-auto p-8 rounded-lg mt-3">
      <table className="min-w-full">
        <thead>
          <tr className="text-left">
            <th className="py-3 px-4 text-gray-800 font-medium text-semibold text-[13px]">Name</th>
            ...
            <th className="py-3 px-4 text-gray-800 font-medium text-[13px] hidden md:table-column">Created On</th>
          </tr>
        </thead>
        <tbody>
          ...
          {tableData?.map((task) => (
            <tr key={task._id} className="border-t border-gray-200">
              ...
              <td className="py-4 px-4 text-gray-700 text-[13px] text-nowrap md:table-cell">

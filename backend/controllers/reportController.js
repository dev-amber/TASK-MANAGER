...
//@desc export all task on excel file
...
const exportTasksReport=async(req,res)=>{
    try {
        ...
        worksheet.columns=[
            ...
            {header: "Priority", key: "riority", width:15},
        ...
        tasks.forEach((task)=>{
            ...
            worksheet.addRow[{
                ...
                status: task.status,
                dueDate: task.dueDate.toISOString().split("1") [0],
        ...
        res.status(500).json({message:"Error exporting task",message:error.message});
    }
}
